...
func newMockTransport() *mockTransport {
    return &mockTransport{buf: new(bytes.Buffer)}
}
...
func TestMessages_Serialization(t *testing.T) {
    t.Run("ClientHello", func(t *testing.T) {
        ...
        rand.Read(msg.X25519Public)
        rand.Read(msg.Random)
    ...
    t.Run("ServerHello", func(t *testing.T) {
        ...
        rand.Read(msg.X25519Public)
        rand.Read(msg.MLKEMPublic)
        rand.Read(msg.MLDSAPublic)
        rand.Read(msg.Random)
        rand.Read(msg.Signature)
