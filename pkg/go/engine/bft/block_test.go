...
func TestBlockSerialization(t *testing.T) {
	...
	tests := []struct {
		name          string
		parseFunc     func(context.Context, []byte) (block.Block, error)
		expectedError error
		blockBytes    []byte
	}{
		{
			...
			parseFunc: func(_ context.Context, b []byte) (block.Block, error) {
		...
		},
		{
			...
			parseFunc: func(_ context.Context, _ []byte) (block.Block, error) {
				return nil, unexpectedBlockBytes
			},
		},
		{
