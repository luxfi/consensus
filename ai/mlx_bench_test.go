...
// BenchmarkMLXBatchProcessing benchmarks GPU batch vote processing
func BenchmarkMLXBatchProcessing(b *testing.B) {
	backend, err := NewMLXBackend(1000)
	if err != nil {
		b.Skip("accel backend not available")
	}
...
// BenchmarkAccelBatchProcessing benchmarks AccelBackend directly
func BenchmarkAccelBatchProcessing(b *testing.B) {
	backend, err := NewAccelBackend(1000)
	if err != nil {
		b.Skip("accel backend not available")
	}
