...
// unaryThreshold implements unary threshold consensus
...
func (sf *unaryThreshold) Extend(choice int) *binaryThreshold {
...
func (sf *unaryThreshold) Clone() *unaryThreshold {
	newThreshold := *sf
