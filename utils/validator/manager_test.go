...
var _ validator.ManagerCallbackListener = (*managerCallbackListener)(nil)
...
var _ validator.SetCallbackListener = (*setCallbackListener)(nil)
...
func TestAddZeroWeight(t *testing.T) {
	...
	m := validator.NewManager()
	err := m.AddStaker(ids.GenerateTestID(), ids.GenerateTestNodeID(), nil, ids.Empty, 0)
	require.ErrorIs(err, validator.ErrZeroWeight)
	// Cannot check unexported field m.subnetToVdrs
}
...
func TestAddDuplicate(t *testing.T) {
	...
	// errDuplicateValidator is not exported, check for the error message instead
	require.Contains(err.Error(), "duplicate validator")
}
...
func TestAddOverflow(t *testing.T) {
	...
	// errTotalWeightNotUint64 is not exported, check for the error message instead
	require.Contains(err.Error(), "total weight is not a uint64")
...
func TestRemoveWeightMissingValidator(t *testing.T) {
	...
	// errMissingValidator is not exported, check for the error message instead
	require.Contains(err.Error(), "missing validator")
}
...
func TestSample(t *testing.T) {
	...
	// errInsufficientWeight is not exported, check for the error message instead
	require.Contains(err.Error(), "insufficient weight")
