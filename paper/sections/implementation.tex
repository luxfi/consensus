...
\item \textbf{quasar package}: P-Chain implementation merging Pulsar threshold signatures with BLS aggregation for post-quantum finality across Nova/Nebula chains.
\end{itemize}
