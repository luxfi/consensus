...
type Parameters struct {
	...
	// post-quantum Corona certificates. This provides quantum-resistant
	// finality on top of the fast metastable BLS consensus.
	Q time.Duration
	
	// QThreshold is the Corona threshold (post-quantum) - number of shares
	// required for a valid quantum certificate.
	QThreshold int
	
	// QuasarTimeout is the maximum time allowed for Corona certificate
