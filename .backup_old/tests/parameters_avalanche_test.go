...
// TestParametersVerifyLuxCompatibility tests parameter validation with
// all the same test cases as Lux to ensure compatibility
func TestParametersVerifyLuxCompatibility(t *testing.T) {
	tests := []struct {
		name          string
		params        Parameters
		wantError     bool
...
// TestMinPercentConnectedHealthyLuxCompatibility tests the MinPercentConnectedHealthy
// calculation matches Lux's implementation
func TestMinPercentConnectedHealthyLuxCompatibility(t *testing.T) {
	tests := []struct {
		name                        string
		params                      Parameters
