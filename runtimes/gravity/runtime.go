...
import (
	...
	"github.com/luxfi/consensus/runtimes/galaxy"
	"github.com/luxfi/consensus/runtimes/orbit"
...
func New(params Parameters) (*Runtime, error) {
	...
	engine, err := quasar.New(quasar.Parameters{
		Mode:          params.UnifiedConsensusMode,
		SecurityLevel: params.QuantumSecurityLevel,
	})
	if err != nil {
...
func (r *Runtime) CreateOrbit(name string, params orbit.Parameters) error {
	...
	orbitRuntime, err := orbit.New(params)
	if err != nil {
...
func (r *Runtime) CreateGalaxy(name string, params galaxy.Parameters) error {
	...
	galaxyRuntime, err := galaxy.New(params)
	if err != nil {
