...
type Config struct {
	...
	EnableCorona bool // Enable Corona PQ signatures
	EnableBLS      bool // Enable BLS aggregation

	// Corona parameters
	AlphaPQ uint32 // Quorum for PQ (default 2F+1)
	QRounds uint32 // Q rounds for Corona
}
...
type Proof struct {
	...
	CoronaProof *PQBundle  // Optional Corona PQ proof
}
...
// PQBundle contains Corona post-quantum proof
...
// PQEngine handles optional Corona PQ signatures
