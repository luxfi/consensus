...
func (vm *BatchedVM) GetAncestors(
	...
	if vm.CantGetAncestors && vm.VM.T != nil {
		require.FailNow(vm.VM.T, errGetAncestor.Error())
	}
...
func (vm *BatchedVM) BatchedParseBlock(
	...
	if vm.CantBatchParseBlock && vm.VM.T != nil {
		require.FailNow(vm.VM.T, errBatchedParseBlock.Error())
	}
