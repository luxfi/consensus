...
func TestBlockBuilder(t *testing.T) {
	...
	tests := []struct {
		...
		vmBlockBuildF func(ctx context.Context) (block.Block, error)
	}{
		{
			...
			shouldBuild:   true,
			expectedBlock: child,
			vmBlockBuildF: func(_ context.Context) (block.Block, error) {
...
func TestBlockBuildingExponentialBackoff(t *testing.T) {
	...
	count := 0
	vm.BuildBlockF = func(_ context.Context) (block.Block, error) {
