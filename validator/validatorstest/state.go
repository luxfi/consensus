...
var _ validator.State = (*State)(nil)
...
type State struct {
	...
	GetValidatorSetF        func(ctx context.Context, height uint64, subnetID ids.ID) (map[ids.NodeID]*validator.GetValidatorOutput, error)
	GetCurrentValidatorSetF func(ctx context.Context, subnetID ids.ID) (map[ids.ID]*validator.GetCurrentValidatorOutput, uint64, error)
}
