...
// auth digest in this package. Mirrors the same primitives in
...
// appendU16 / appendU32 / appendU64 are the in-place writers used by
// the Marshal codecs in this package.
