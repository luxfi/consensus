...
func BenchmarkCoronaKeyGen(b *testing.B) {
	seed := make([]byte, 32)
	rand.Read(seed)
...
func BenchmarkCoronaPrecompute(b *testing.B) {
	sk := make([]byte, 32)
	rand.Read(sk)
...
func BenchmarkCoronaQuickSign(b *testing.B) {
	sk := make([]byte, 32)
	rand.Read(sk)
...
func BenchmarkCoronaAggregate(b *testing.B) {
