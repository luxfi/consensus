...
// SP 800-185 transcript-input helpers for the witness signing digest
// live in witness_transcript.go — see that file for the byte-encoding
// kernel. SigningDigest() consumes them.
