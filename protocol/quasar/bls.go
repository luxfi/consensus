...
// createHorizonSignature creates a Corona + BLS fusion signature for the event horizon.
// The signature combines:
// 1. BLS aggregate signature (32 bytes) - for efficiency
// 2. Corona post-quantum hash (32 bytes) - for security binding
//
// Note: Full threshold signing (multi-party Corona) is handled by Quasar.hybridConsensus.
