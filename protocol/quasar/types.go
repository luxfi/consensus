...
//   2. PQ proof (variable) — post-quantum (ML-DSA-65 FIPS 204, or Corona Ring-LWE)
//
// In triple mode (BLS + Corona + ML-DSA), PQProof carries the aggregated
// post-quantum material from both Corona threshold and ML-DSA identity sigs.
