// Package quasar implements Quasar triple consensus: BLS + Corona + ML-DSA.
//
...
//   - Corona (Ring-LWE) threshold signatures — post-quantum lattice path
...
// consensus. BLS + Corona gives PQ-safe threshold finality. Full triple
