...
type newConsensusFunc func(factory *consensus.Factory, params config.Parameters, choice ids.ID) Consensus
...
func NewTestNetwork(factory *consensus.Factory, params config.Parameters, numColors int, rngSource sampler.Source) *TestNetwork {
	n := &TestNetwork{
		params:    params,
		rngSource: rngSource,
		factory:   factory,
...
func (n *TestNetwork) AddNodeSpecificColor(
