...
- **Quasar Consensus**: BLS + Corona + ML-DSA — three independent cryptographic hardness assumptions for PQ-safe finality
...
- BLS + Corona + ML-DSA: full Quasar (`TripleSignRound1`, all 3 in parallel)
...
- `hybrid_consensus.go` → `hybrid.go` (BLS + Corona hybrid)
...
- Examples:
  - Corona+BLS fusion (future post-quantum enhancement)
