...
- BLS + Corona: dual PQ with Ring-LWE 2-round threshold
- BLS + Corona + ML-DSA: full Quasar (`TripleSignRound1`, all 3 parallel)

`IsTripleMode()` checks all three configured.
Real crypto via `luxfi/crypto/bls`, `luxfi/crypto/mldsa`, `luxfi/corona/threshold`.
