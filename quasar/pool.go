...
// Pool keeps <N> ready-made Corona shares in RAM per validator.
type Pool struct {
	mu     sync.Mutex
	cache  []Share
	sk     SecretKey
...
// Available returns the number of precomputed shares available.
...
// SetTarget adjusts the target number of shares to maintain.
